...
import 'package:gharelu_app/Screens/GareluScreen/Screen/Sigup/SignUp_Screen.dart';
...
class Authentication {
  ...
  UserModel userFromFirebaseUser(User firebaseUser) {
    return firebaseUser == null ? null : UserModel(firebaseUser.uid);
  }

  Stream<UserModel> get userStream {
    return _auth.authStateChanges().map((User) => userFromFirebaseUser(User));
  }
